...
def annotate(im, do_display=True, do_save=True, do_print=True, annotation_color=(255, 0, 0), epsilon=0.005, configuration=POLY_APPROX, object_configuration=SINGLE_OBJ, do_cvt=True):
